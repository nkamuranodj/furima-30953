...
ActiveRecord::Schema.define(version: 2021_03_09_105355) do
  ...
  create_table "items", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.integer "deliverypayer_id", null: false
  ...
  create_table "shipsdeliveries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buyer_id"], name: "index_shipsdeliveries_on_buyer_id"
  end
  ...
  add_foreign_key "shipsdeliveries", "buyers"
end
